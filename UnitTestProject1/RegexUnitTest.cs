...
namespace UnitTestProject1
{
    ...
    public class RegexUnitTest
    {
        ...
        public void Test_MatchRegexLiteral(String input, bool isMatch)
        {
            ...
            string pattern = "A regex is a sequence of characters that define a search pattern";
